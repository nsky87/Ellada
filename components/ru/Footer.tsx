      ...
      <div className="grid gap-12 md:grid-cols-[2fr_1fr_1fr]">
        ...
        <div>
          ...
          <p className="text-muted max-w-sm text-sm leading-relaxed">
            ...
            с характером, атмосферой и прицелом на результат.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <a href="https://t.me/+380999391627" target="_blank" rel="noopener noreferrer" aria-label="Написать в Telegram" className="footer-link">
              Telegram
            </a>
            <a href="https://wa.me/380999391627" target="_blank" rel="noopener noreferrer" aria-label="Написать в WhatsApp" className="footer-link">
              WhatsApp
            </a>
          </div>
        </div>
