...
const faqs = [
  {
    ...
    answer: "Всё зависит от проекта — большинство сайтов начинаются от $1000. После короткого разговора дадим чёткую цену без скрытых платежей.",
  },
  {
  ...
  },
  {
    ...
    answer: "Да, и это стандартная практика. Работаем удалённо с клиентами по всему миру — звонки, правки и сдача проекта онлайн.",
  },
  {
